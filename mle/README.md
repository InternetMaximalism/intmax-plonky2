...
The [Lean audit archive](audit/README.md) is retained from the July 2026 protocol
and its D3 follow-up. It assumes PCS binding and abstracts parts of WHIR and
transcript reconstruction. Its theorems and historical test results do not
certify the current wire-v3 Rust/Solidity implementation or close the remaining
Fiat--Shamir, external-review, and parent-integration release gates.

See the [main repair integration record](audit/main-pcs-repair-2026-09-05.md)
for the reviewed-gap mapping and the validation results for this integration.
...
The pre-integration 2026-09-03 local gate ran 347 Forge tests in 27 suites with zero failures
