...
EXTERNAL_IMPORTS = {
    ...
    "Audit.Wire3.LocalizedCollisions": frozenset({
        "Mathlib.Data.Fintype.Card", "Mathlib.Data.Fintype.BigOperators", "Mathlib.Data.Fintype.Pi"}),
...
REQUIRED_MODULES = {"Audit.Wire3." + name for name in (
    ...
    "GateCosetPolynomial", "GatePoseidonPolynomial", "GateAllPolynomial",
    ...
    "GateDenseRound", "OpeningBinding", "ZeroCheckSemantics", "GateClaimChain",
    "AlphaZeroCheck", "GateRejectionPower", "GateDerivedRejection", "CommitmentOrder",
    "ChallengeUnionBound", "AttachedUnionBound", "ConstantsProvenance",
    "JointChallengeSpace", "GatePointZeroCheck",
    "OuterSequentialConditioning", "InstalledWhirTail",
    "AdaptiveAgreementFamily", "PinnedWhirProfile",
    ...
    "SoundnessAssembly", "CanonicalProofCheck",
    "ExtractorConstruction", "RustCallBoundary",
    "LocalizedCollisions", "RandomOracleSqueezes",
    "OpenedDotBinding", "BirthdayClashBound",
    "ConcreteChainThreading", "IndexLanesOracle",
    "RunLevelUnionBound", "StrategyChainBound",
    "GrindingQueryBound", "TwoStageConditionalCount",
    "IndexStageFinerSplit", "OuterLaneTransport",
    "IndexGuardLiveness", "GrindingLinearBound", "ReducedFullTransport",
    "ReducedIndexLanes", "GrindingGraphBound",
    "ReducedEngineIndex", "RawBlockLanes",
    "RawIndexLanes", "RunLevelTransportAudit",
    "CommitmentOrderSurvey", "GrindingUnionBound", "EngineTauDiagonal",
    "EngineOuterDiagonal", "PreReadCharge",
    "CommittedTablesClauses", "AdaptiveAssemblyFailure",
    "IndexHalfTransport", "LocalizedCollisionMasses",
    "NonDegenerateAcceptance", "GrindLanePairing",
    "DerivedAcceptance", "TwoLaneMessages",
